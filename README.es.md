...
| **Antigravity** | `~/.gemini/config/` (`AGENTS.md`, `rules/`, `workflows/`, `skills/`, `mcp_config.json`) | `.agents/rules/`, `.agents/workflows/`, `.agents/skills/`, `.agents/AGENTS.md` | Antigravity de Google (no Claude Desktop); ver [ADR-019](docs/decisions/ADR-019-opencode-antigravity-customizations.md) |
