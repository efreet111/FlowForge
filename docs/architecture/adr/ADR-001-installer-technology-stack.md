...
> **Nota:** Antigravity 2.0 usa `~/.gemini/config/` para customizations (ver [ADR-019](../../decisions/ADR-019-opencode-antigravity-customizations.md)); Claude Desktop sólo expone MCP en `~/.config/Claude/claude_desktop_config.json`.
