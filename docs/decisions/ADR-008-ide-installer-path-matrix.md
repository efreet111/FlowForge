...
| Antigravity (Google) | `~/.gemini/config/` con `AGENTS.md`, `rules/`, `global_workflows/`, `skills/` y `mcp_config.json` | `.agents/rules/`, `.agents/workflows/`, `.agents/skills/`, `AGENTS.md` | `~/.gemini` — ver [ADR-011](ADR-011-opencode-antigravity-customizations.md) para Antigravity 2.0 |
