...
| **Ideal para** | Primera instalación, setup completo | Refresco rápido, CI/CD, ya tenés engram |
...
**Regla rápida:**
- ¿Primera vez? → Usá **Stack installer**
- ¿Ya tenés flowforge + engram, solo querés actualizar agentes? → Usá **IDE installer**
